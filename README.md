...
| packageDetails       | object | REQUIRED | Details of the sender i.e.<br/> `{"packageDetails" :{packageWeightKg : double (OPTIONAL)<br/> packageHeightCm : double (OPTIONAL)<br/> packageWidthCm : double (OPTIONAL)<br/> packageTotalCost : double (OPTIONAL)<br/> itemLabel : String (REQUIRED)<br/> itemDescription : (REQUIRED)<br/> itemColor : String (OPTIONAL)<br/> itemImageUrl : String (OPTIONAL)<br/> itemQuantity : int (REQUIRED)<br/>}}` |                                                                                                                                                                                                                                                                                                                        |
